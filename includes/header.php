...
<head>
    ...
    <meta name="apple-mobile-web-app-status-bar-style" content="#4ade80">
    <style>
        /* Custom scrollbar */
        ::-webkit-scrollbar {
            width: 8px;
        ...
        .bg-image {
            background-image: url('/assets/images/dairy-farm-bg.jpg');
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex-shrink-0">
                        <a href="<?php echo BASE_URL; ?>dashboard.php" class="text-white text-lg font-bold hover:text-gray-200">MIM Dairy Farm</a>
                    </div>
